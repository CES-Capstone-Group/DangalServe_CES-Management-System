        ...
        <SidebarMenu.Body>
          ...
          <SidebarMenu.Nav>
            <SidebarMenu.Sub>
              <SidebarMenu.Sub.Toggle>
                <SidebarMenu.Nav.Icon>
                  <FontAwesomeIcon onClick={toggleSidebar} icon={faChartLine} style={{ color: 'grey', fontSize: sidebarOpen ? '20px' : '22px', marginBottom: sidebarOpen ? '0px' : '10px' }} />
                </SidebarMenu.Nav.Icon>
          ...
          <SidebarMenu.Nav>
            <NavLink to={'/landing'} className={({ isActive }) => "nav-link" + (isActive ? " active" : "")}>
              <SidebarMenu.Nav.Icon>
                <FontAwesomeIcon icon={faCircleArrowLeft} style={{ color: '#71A872', fontSize: sidebarOpen ? '20px' : '22px', marginBottom: sidebarOpen ? '0px' : '10px' }} />
              </SidebarMenu.Nav.Icon>
