    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_objectives', models.TextField(default='')),
                ('activity_venue', models.CharField(default='', max_length=255)),
                ...
                ('brgy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='api.barangay')),
